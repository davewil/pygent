...
Use 'pygent tools' to see all available tools.
Use 'pygent tools -c <category>' to filter by category.
""",
    "config_invalid": """Invalid configuration: {error}

Check your configuration file:
  pygent config path    # Show config file location
...
Use 'pygent sessions' to see all saved sessions.
""",
    "invalid_command": """Unknown command: {command}

Use 'pygent --help' to see all available commands.
""",
...
Configure with: pygent config set llm.provider <provider>
""",
...
Increase the limit:
  pygent config set llm.max_tokens 8192

Or ask for a shorter response.
""",
    "first_run": """Welcome to Pygent!

It looks like this is your first time running pygent.
...
def get_suggestion_for_error(error_code: str) -> str | None:
    ...
    suggestions: dict[str, str] = {
        ...
        "model_not_found": "Try: pygent config set llm.model claude-sonnet-4-20250514",
        ...
        "config_invalid": "Run: pygent config init --force",
        "session_not_found": "Run: pygent sessions",
