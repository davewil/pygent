...
class TestSlashCommandsConstant:
    ...
    def test_contains_session_commands(self):
    ...
    def test_contains_ui_toggle_commands(self):
...
class TestParseSlashCommand:
    ...
    def test_parses_command_with_one_arg(self):
    ...
    def test_returns_none_for_non_slash_input(self):
...
class TestGetCommandHelp:
    ...
    def test_returns_help_for_valid_command(self):
    ...
    def test_includes_args_pattern(self):
...
class TestPropertyBased:
    ...
    def test_slash_command_matches_self(self, name):
    ...
    @settings(max_examples=20)
    def test_slash_command_matches_aliases(self, name, aliases):
    ...
    @settings(max_examples=20)
    def test_parse_never_crashes(self, user_input):
...
class TestEdgeCases:
    ...
    def test_empty_name_slash_command(self):
        """Test SlashCommand with empty name."""
        cmd = SlashCommand(name="")
        assert cmd.matches("") is True

    def test_slash_command_with_special_chars_in_name(self):
...
class TestIntegration:
    ...
    def test_parse_and_lookup_workflow(self):
    ...
    def test_all_commands_can_be_parsed(self):
